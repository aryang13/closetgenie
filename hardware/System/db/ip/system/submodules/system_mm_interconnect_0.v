...
module system_mm_interconnect_0 (
		...
		output wire [2:0]  GPS_UART_s1_address,                     //                       GPS_UART_s1.address
		output wire        GPS_UART_s1_write,                       //                                  .write
		output wire        GPS_UART_s1_read,                        //                                  .read
		input  wire [15:0] GPS_UART_s1_readdata,                    //                                  .readdata
		output wire [15:0] GPS_UART_s1_writedata,                   //                                  .writedata
		output wire        GPS_UART_s1_begintransfer,               //                                  .begintransfer
		output wire        GPS_UART_s1_chipselect,                  //                                  .chipselect
	...
	wire   [5:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> TIMER_s1_agent:cp_channel
	...
	wire  [93:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> SRAM_s1_agent:cp_data
	...
	wire  [17:0] wifi_uart_s1_agent_m0_address;                                               // WIFI_UART_s1_agent:m0_address -> WIFI_UART_s1_translator:uav_address
	...
	wire  [94:0] wifi_uart_s1_agent_rf_source_data;                                           // WIFI_UART_s1_agent:rf_source_data -> WIFI_UART_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] wifi_uart_s1_agent_rsp_fifo_out_data;                                        // WIFI_UART_s1_agent_rsp_fifo:out_data -> WIFI_UART_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> WIFI_UART_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> WIFI_UART_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // WIFI_UART_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> WIFI_UART_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> WIFI_UART_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> WIFI_UART_s1_agent:cp_endofpacket
	wire  [31:0] gps_uart_s1_agent_m0_readdata;                                               // GPS_UART_s1_translator:uav_readdata -> GPS_UART_s1_agent:m0_readdata
	wire         gps_uart_s1_agent_m0_waitrequest;                                            // GPS_UART_s1_translator:uav_waitrequest -> GPS_UART_s1_agent:m0_waitrequest
	wire         gps_uart_s1_agent_m0_debugaccess;                                            // GPS_UART_s1_agent:m0_debugaccess -> GPS_UART_s1_translator:uav_debugaccess
	wire  [17:0] gps_uart_s1_agent_m0_address;                                                // GPS_UART_s1_agent:m0_address -> GPS_UART_s1_translator:uav_address
	wire   [3:0] gps_uart_s1_agent_m0_byteenable;                                             // GPS_UART_s1_agent:m0_byteenable -> GPS_UART_s1_translator:uav_byteenable
	wire         gps_uart_s1_agent_m0_read;                                                   // GPS_UART_s1_agent:m0_read -> GPS_UART_s1_translator:uav_read
	wire         gps_uart_s1_agent_m0_readdatavalid;                                          // GPS_UART_s1_translator:uav_readdatavalid -> GPS_UART_s1_agent:m0_readdatavalid
	wire         gps_uart_s1_agent_m0_lock;                                                   // GPS_UART_s1_agent:m0_lock -> GPS_UART_s1_translator:uav_lock
	wire  [31:0] gps_uart_s1_agent_m0_writedata;                                              // GPS_UART_s1_agent:m0_writedata -> GPS_UART_s1_translator:uav_writedata
	wire         gps_uart_s1_agent_m0_write;                                                  // GPS_UART_s1_agent:m0_write -> GPS_UART_s1_translator:uav_write
	wire   [2:0] gps_uart_s1_agent_m0_burstcount;                                             // GPS_UART_s1_agent:m0_burstcount -> GPS_UART_s1_translator:uav_burstcount
	wire         gps_uart_s1_agent_rf_source_valid;                                           // GPS_UART_s1_agent:rf_source_valid -> GPS_UART_s1_agent_rsp_fifo:in_valid
	wire  [94:0] gps_uart_s1_agent_rf_source_data;                                            // GPS_UART_s1_agent:rf_source_data -> GPS_UART_s1_agent_rsp_fifo:in_data
	wire         gps_uart_s1_agent_rf_source_ready;                                           // GPS_UART_s1_agent_rsp_fifo:in_ready -> GPS_UART_s1_agent:rf_source_ready
	wire         gps_uart_s1_agent_rf_source_startofpacket;                                   // GPS_UART_s1_agent:rf_source_startofpacket -> GPS_UART_s1_agent_rsp_fifo:in_startofpacket
	wire         gps_uart_s1_agent_rf_source_endofpacket;                                     // GPS_UART_s1_agent:rf_source_endofpacket -> GPS_UART_s1_agent_rsp_fifo:in_endofpacket
	wire         gps_uart_s1_agent_rsp_fifo_out_valid;                                        // GPS_UART_s1_agent_rsp_fifo:out_valid -> GPS_UART_s1_agent:rf_sink_valid
	wire  [94:0] gps_uart_s1_agent_rsp_fifo_out_data;                                         // GPS_UART_s1_agent_rsp_fifo:out_data -> GPS_UART_s1_agent:rf_sink_data
	wire         gps_uart_s1_agent_rsp_fifo_out_ready;                                        // GPS_UART_s1_agent:rf_sink_ready -> GPS_UART_s1_agent_rsp_fifo:out_ready
	wire         gps_uart_s1_agent_rsp_fifo_out_startofpacket;                                // GPS_UART_s1_agent_rsp_fifo:out_startofpacket -> GPS_UART_s1_agent:rf_sink_startofpacket
	wire         gps_uart_s1_agent_rsp_fifo_out_endofpacket;                                  // GPS_UART_s1_agent_rsp_fifo:out_endofpacket -> GPS_UART_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> GPS_UART_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> GPS_UART_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // GPS_UART_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> GPS_UART_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> GPS_UART_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> GPS_UART_s1_agent:cp_endofpacket
	...
	wire  [93:0] sram_s1_agent_rp_data;                                                       // SRAM_s1_agent:rp_data -> router_005:sink_data
	...
	wire         wifi_uart_s1_agent_rp_valid;                                                 // WIFI_UART_s1_agent:rp_valid -> router_006:sink_valid
	wire  [93:0] wifi_uart_s1_agent_rp_data;                                                  // WIFI_UART_s1_agent:rp_data -> router_006:sink_data
	wire         wifi_uart_s1_agent_rp_ready;                                                 // router_006:sink_ready -> WIFI_UART_s1_agent:rp_ready
	wire         wifi_uart_s1_agent_rp_startofpacket;                                         // WIFI_UART_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         wifi_uart_s1_agent_rp_endofpacket;                                           // WIFI_UART_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         gps_uart_s1_agent_rp_valid;                                                  // GPS_UART_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] gps_uart_s1_agent_rp_data;                                                   // GPS_UART_s1_agent:rp_data -> router_007:sink_data
	wire         gps_uart_s1_agent_rp_ready;                                                  // router_007:sink_ready -> GPS_UART_s1_agent:rp_ready
	wire         gps_uart_s1_agent_rp_startofpacket;                                          // GPS_UART_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         gps_uart_s1_agent_rp_endofpacket;                                            // GPS_UART_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         wifi_uart_s1_agent_rdata_fifo_src_valid;                                     // WIFI_UART_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] wifi_uart_s1_agent_rdata_fifo_src_data;                                      // WIFI_UART_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         wifi_uart_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_004:in_0_ready -> WIFI_UART_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> WIFI_UART_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> WIFI_UART_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // WIFI_UART_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> WIFI_UART_s1_agent:rdata_fifo_sink_error
	wire         gps_uart_s1_agent_rdata_fifo_src_valid;                                      // GPS_UART_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] gps_uart_s1_agent_rdata_fifo_src_data;                                       // GPS_UART_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         gps_uart_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_005:in_0_ready -> GPS_UART_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> GPS_UART_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> GPS_UART_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // GPS_UART_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> GPS_UART_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) gps_uart_s1_translator (
		.clk                    (clk_0_clk_clk),                           //                      clk.clk
		.reset                  (NIOS2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (gps_uart_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (gps_uart_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (gps_uart_s1_agent_m0_read),               //                         .read
		.uav_write              (gps_uart_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (gps_uart_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (gps_uart_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (gps_uart_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (gps_uart_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (gps_uart_s1_agent_m0_writedata),          //                         .writedata
		.uav_lock               (gps_uart_s1_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (gps_uart_s1_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (GPS_UART_s1_address),                     //      avalon_anti_slave_0.address
		.av_write               (GPS_UART_s1_write),                       //                         .write
		.av_read                (GPS_UART_s1_read),                        //                         .read
		.av_readdata            (GPS_UART_s1_readdata),                    //                         .readdata
		.av_writedata           (GPS_UART_s1_writedata),                   //                         .writedata
		.av_begintransfer       (GPS_UART_s1_begintransfer),               //                         .begintransfer
		.av_chipselect          (GPS_UART_s1_chipselect),                  //                         .chipselect
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
		.av_byteenable          (),                                        //              (terminated)
		.av_readdatavalid       (1'b0),                                    //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                //             clk.clk
		.reset                   (NIOS2_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (gps_uart_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (gps_uart_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (gps_uart_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (gps_uart_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (gps_uart_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (gps_uart_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (gps_uart_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (gps_uart_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (gps_uart_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (gps_uart_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (gps_uart_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (gps_uart_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (gps_uart_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (gps_uart_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (gps_uart_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (gps_uart_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (gps_uart_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (gps_uart_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (gps_uart_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (gps_uart_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (gps_uart_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (gps_uart_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (gps_uart_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (gps_uart_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (gps_uart_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (gps_uart_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),            //                .error
		.rdata_fifo_src_ready    (gps_uart_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (gps_uart_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (gps_uart_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) gps_uart_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (NIOS2_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (gps_uart_s1_agent_rf_source_data),             //        in.data
		.in_valid          (gps_uart_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (gps_uart_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (gps_uart_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (gps_uart_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (gps_uart_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (gps_uart_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (gps_uart_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (gps_uart_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (gps_uart_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	system_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (gps_uart_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (gps_uart_s1_agent_rp_valid),              //          .valid
		.sink_data          (gps_uart_s1_agent_rp_data),               //          .data
		.sink_startofpacket (gps_uart_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (gps_uart_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (NIOS2_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (gps_uart_s1_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (gps_uart_s1_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (gps_uart_s1_agent_rdata_fifo_src_ready),  //         .ready
